...
public class List {
    ...
    public void addFirst(char chr) {
        ...
        this.first = new Node(newCharData, this.first);
    ...
    public boolean remove(char chr) {
        //finds the node to remove using to pointers, prev is one step behind
        Node prev = null;
        Node current = first;
    ...
    public CharData get(int index) {
        ...
        return null; //if somehow there wasn't an index out of bounds exception or a Char data return
    }
